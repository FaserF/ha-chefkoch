# AI Context & Instructions for ha-chefkoch

## 🧬 Project DNA
**Repository:** `ha-chefkoch`
**Type:** Home Assistant Custom Integration
**Domain:** `chefkoch_ha`
**Description:** The **Chefkoch** integration brings recipes from Germany's largest cooking platform, Chefkoch.de, directly into Home Assistant.
...
### 🚀 Google Antigravity
- **Codebase Navigation:** Begin by analyzing `custom_components/chefkoch_ha/`. Search for established patterns in `api.py` or `coordinator.py` before modifying entities.
